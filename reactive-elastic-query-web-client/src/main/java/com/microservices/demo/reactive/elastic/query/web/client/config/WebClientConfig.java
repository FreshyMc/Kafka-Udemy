...
public class WebClientConfig {
    ...
    public WebClientConfig(ElasticQueryWebClientConfigData webClient) {
    ...
    WebClient webClient() {
        return WebClient.builder()
                ...
                .clientConnector(new ReactorClientHttpConnector(HttpClient.from(getTcpCliet())))
                .build();
    }

    private TcpClient getTcpCliet() {
